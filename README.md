...
📁 Структура проекта
1. main.py             # Источниковый файл бота
2. nomenclature.txt    # Исходный текстовый файл с данными
3. nomenclature.json   # Файл с номенклатурой в формате JSON
4. README.md           # Это описание
